...
Charts are generated by CI across GCC and Clang via the [benchmark workflow](https://github.com/flatironinstitute/poet/actions/workflows/benchmarks.yml):
...
CodSpeed regression tracking is currently disabled: its project still points at
